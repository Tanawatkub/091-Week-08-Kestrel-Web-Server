...
เมื่อถอดสาย USB ระบบตรวจไม่พบข้อมูลจากพอร์ต จึงสลับเข้าสู่ **Simulation Mode** อัตโนมัติ

- **`dataSource`** เปลี่ยนเป็น `"Simulation Mode (Sine Wave)"`
- **`rawValue`** ยังคงเปลี่ยนแปลงได้ตลอดเวลา แต่เปลี่ยนตาม **สูตรคลื่นไซน์** ที่คำนวณจากเวลาของระบบ (ไม่ใช่จากการหมุนโพเทนชิโอมิเตอร์จริงแล้ว) ค่าจะแกว่งขึ้น-ลงระหว่าง 0-4095 เป็นรูปคลื่นไปเรื่อยๆ
---
